...
import { CreateUser, GetRoleTypes, GetUser } from "Data/Users.Controller";
import { toast } from "react-toastify";
import { useRouter } from "next/router";

const KullaniciEkle = ({ roleTypes, user }) => {
    ...
    const [userValues, setUserValues] = useState({
        ...
        email: user.email,
        AlkolKullanim: user.AlkolKullanim,
        SigaraKullanim: user.SigaraKullanim,
                ...
                <Grid.Container gap={2}>
                    ...
                    <Grid xs={12} >
                        <Radio.Group size="sm" css={{ fontSize: "15px" }}
                            ...
                            label="Cinsiyet" orientation="horizontal" value={user.Cinsiyet}>
                    ...
                    <Grid xs={12} >
                        <Radio.Group size="sm" css={{ fontSize: "15px" }}
                            ...
                            label="Alkol Kullanım" orientation="horizontal" value={user.AlkolKullanim}>
                    ...
                    <Grid xs={12} >
                        <Radio.Group size="sm" css={{ fontSize: "15px" }}
                            ...
                            label="Sigara Kullanım" orientation="horizontal" value={user.SigaraKullanim}>
                    ...
                    <Grid xs={12}>
                        <Radio.Group size="sm" css={{ fontSize: "15px" }}
                            ...
                            label="Rol Tipi" orientation="horizontal" defaultValue={userValues.role} >
                            {
